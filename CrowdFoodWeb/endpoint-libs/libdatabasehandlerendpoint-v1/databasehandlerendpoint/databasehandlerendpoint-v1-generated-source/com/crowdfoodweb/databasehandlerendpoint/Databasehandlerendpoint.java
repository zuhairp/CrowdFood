...
public class Databasehandlerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetDatabaseHandler getDatabaseHandler(java.lang.Long id) throws java.io.IOException {
  ...
  public class GetDatabaseHandler extends DatabasehandlerendpointRequest<com.crowdfoodweb.databasehandlerendpoint.model.DatabaseHandler> {
     ...
     * @since 1.13
     */
    protected GetDatabaseHandler(java.lang.Long id) {
    ...
    public GetDatabaseHandler setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveDatabaseHandler removeDatabaseHandler(java.lang.Long id) throws java.io.IOException {
  ...
  public class RemoveDatabaseHandler extends DatabasehandlerendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveDatabaseHandler(java.lang.Long id) {
    ...
    public RemoveDatabaseHandler setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
